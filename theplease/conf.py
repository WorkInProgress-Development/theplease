...
class Settings(dict):
    ...
    def _get_user_dir_path(self):
        ...
        user_dir = Path(xdg_config_home, 'theplease').expanduser()
        legacy_user_dir = Path('~', '.theplease').expanduser()

        # For backward compatibility use legacy '~/.theplease' if it exists:
