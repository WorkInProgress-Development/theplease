from theplease.specific.npm import npm_available
from theplease.utils import replace_argument, for_app, eager, get_closest
from theplease.specific.sudo import sudo_support
