...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[theplease.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype theplease.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[theplease.types.CorrectedCommand]
    :rtype: theplease.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('Nothing found' if get_alias() == 'please'
                    else 'Nothing found')
        return
