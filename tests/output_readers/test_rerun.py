...
from theplease.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('theplease.output_readers.rerun.Process')
    ...
    @patch('theplease.output_readers.rerun._wait_output', return_value=False)
    @patch('theplease.output_readers.rerun.Popen')
    ...
    @patch('theplease.output_readers.rerun._kill_process')
    ...
    @patch('theplease.output_readers.rerun.logs')
