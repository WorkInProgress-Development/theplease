...
from theplease import corrector, const
from theplease.system import Path
from theplease.types import Command
from theplease.corrector import get_corrected_commands, organize_commands


@pytest.fixture
def glob(mocker):
    results = {}
    mocker.patch('theplease.system.Path.glob',
...
class TestGetRules(object):
    ...
    def load_source(self, monkeypatch):
        monkeypatch.setattr('theplease.types.load_source',
                            lambda x, _: Rule(x))
...
def test_get_corrected_commands(mocker):
    ...
    rules = [Rule(match=lambda _: False),
             ...
             Rule(match=lambda _: True,
                  ...
                  priority=60)]
    mocker.patch('theplease.corrector.get_rules', return_value=rules)
