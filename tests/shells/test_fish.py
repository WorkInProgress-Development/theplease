...
from theplease.shells import Fish
...
class TestFish(object):
    ...
    def Popen(self, mocker):
        mock = mocker.patch('theplease.shells.fish.Popen')
    ...
    def test_app_alias(self, shell):
        ...
        assert 'TF_SHELL=fish' in shell.app_alias('please')
        ...
        assert ARGUMENT_PLACEHOLDER in shell.app_alias('please')
    ...
    def test_put_to_history(self, entry, entry_utf8, builtins_open, mocker, shell):
        mocker.patch('theplease.shells.fish.time', return_value=1430707243.3517463)
